...
export namespace Op {
    ...
    const op_code_map: {
        ...
        0xa8: { asm: (gb) => { return "XOR  B"; },
                func: (gb) => { gb.regs.a ^= gb.regs.b; Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = gb.flags.carry = false; }},
        0xa9: { asm: (gb) => { return "XOR  C"; },
                func: (gb) => { gb.regs.a ^= gb.regs.c; Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = gb.flags.carry = false; }},
        0xaa: { asm: (gb) => { return "XOR  D"; },
                func: (gb) => { gb.regs.a ^= gb.regs.d; Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = gb.flags.carry = false; }},
        0xab: { asm: (gb) => { return "XOR  E"; },
                func: (gb) => { gb.regs.a ^= gb.regs.e; Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = gb.flags.carry = false; }},
        0xac: { asm: (gb) => { return "XOR  H"; },
                func: (gb) => { gb.regs.a ^= gb.regs.h; Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = gb.flags.carry = false; }},
        0xad: { asm: (gb) => { return "XOR  L"; },
                func: (gb) => { gb.regs.a ^= gb.regs.l; Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = gb.flags.carry = false; }},
        0xae: { asm: (gb) => { return `XOR  (HL)`; },
                func: (gb) => { const hl = ((gb.regs.h&0xff)<<8) | (gb.regs.l&0xff); gb.regs.a ^= Memory.readUByte(gb.mem, hl); Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = gb.flags.carry = false; }},
        0xaf: { asm: (gb) => { return "XOR  A"; },
                func: (gb) => { gb.regs.a ^= gb.regs.a; Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = gb.flags.carry = false; }},
        ...
        0xc6: { asm: (gb) => { return `ADD  A,${hexByte(Memory.readSByte(gb.mem, gb.regs.pc))}`; },
                func: (gb) => { gb.regs.a += Gb.loadUByte(gb); Register.updateFlags(gb, gb.regs.a, 0xb0); }},
        ...
        0xe6: { asm: (gb) => { return `AND  A,${hexByte(Memory.readSByte(gb.mem, gb.regs.pc))}`; },
                func: (gb) => { gb.regs.a &= Gb.loadUByte(gb); Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = true; gb.flags.carry = false; }},
