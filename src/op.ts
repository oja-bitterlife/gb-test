...
export namespace Op {
    ...
    const op_code_map: {
        ...
        0x1a: { asm: (gb) => { return `LD   A,(DE)`; },
                func: (gb) => { const de = ((gb.regs.d&0xff)<<8) | (gb.regs.e&0xff); gb.regs.a = Memory.readSByte(gb.mem, de); }},
        ...
        0xc6: { asm: (gb) => { return `ADD  A,${hexByte(Memory.readSByte(gb.mem, gb.regs.pc))}`; },
                func: (gb) => { gb.regs.a = (gb.regs.a + Gb.loadUByte(gb))&0xff; Register.updateFlags(gb, gb.regs.a, 0xb0); }},
        ...
        0xd6: { asm: (gb) => { return `SUB  ${hexByte(Memory.readSByte(gb.mem, gb.regs.pc))}`; },
                func: (gb) => { gb.regs.a = (gb.regs.a-Gb.loadUByte(gb))&0xff; Register.updateFlags(gb, gb.regs.a, 0xf0); }},
        ...
        0xe6: { asm: (gb) => { return `AND  A,${hexByte(Memory.readSByte(gb.mem, gb.regs.pc))}`; },
                func: (gb) => { gb.regs.a = (gb.regs.a & Gb.loadUByte(gb))&0xff; Register.updateFlags(gb, gb.regs.a, 0x80); gb.flags.half_carry = true; gb.flags.carry = false; }},
